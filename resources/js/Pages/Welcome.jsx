...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    if (role === 'superadministrador') homeRoute = 'home.superadministrador';
    else if (role === 'administrador') homeRoute = 'home.administrador';
    else if (role === 'usuario') homeRoute = 'home.usuario';
